...
//    $r->addRoute('GET', '/articles/{id:\d+}[/{title}]', 'get_article_handler');
    ...
    /* Standard Mission Week 7 */
    $r->addRoute('POST', '/user', ['UserController', 'signUp']);
    $r->addRoute('DELETE', '/user', ['UserController', 'withdraw']);
    $r->addRoute('POST', '/user/token', ['UserController', 'signIn']);
    $r->addRoute('DELETE', '/user/token', ['UserController', 'signOut']);
    ...
    $r->addRoute('PATCH', '/board', ['BoardController', 'editPost']);
    $r->addRoute('DELETE', '/board', ['BoardController', 'deletePost']);
    $r->addRoute('POST', '/board/like', ['BoardController', 'likePost']);
